...
from app.repositories.product_color_analysis_compatibility_repository import ProductColorAnalysisCompatibilityRepository
from app.dependencies.dependencies import get_product_color_analysis_compatibility_repository
...
def update_product_color_analysis_compatibility(
    compatibility_id: uuid.UUID,
    compatibility_data: ProductColorAnalysisCompatibilityUpdate,
    repo: ProductColorAnalysisCompatibilityRepository = Depends(get_product_color_analysis_compatibility_repository)
):
